...
public class reworkhealthunit{

	public void writehealthunit(String datedebut , String datefin , int valuetosend , String valuemed1 , String valuemed2 , String valuemed3 , String valuemed4 , String valuemed5 , JTextArea loadingarea) {  
    ...
    try (XWPFDocument document = new XWPFDocument()) {
		...
		titre.setText("INTERVENTION");
		titre.addBreak();
		if(newdatefin.equals("")) {
			titre.setText("DU " + newdatedebut);
		}else{
						...
						Connection con = DriverManager.getConnection("");
							...
							for (int i = 0 ; i < 500; i++) {
								...
								if(compteurpage % 5 == 0) {
									...
									compteurnbpage++;
									System.out.println(compteurnbpage);
						...
						Connection con = DriverManager.getConnection("");
							...
							//1 MEDECIN 
						    	...
						    	if(pickspenum.equals("0")) {	
							    	...
							    	query = "SELECT OP.PATNAME , OP.PATFIRSTNAME, OP.PATSEX , OP.SURGNB , OP.LATEX , OP.PATNB , OP.ENTRYDT , OP.MEDSPE , OP.ANESNAME , OP.OPEXPBEGHR , OP.LITDEM , OP.ROOMID , OP.ENTRYHR , OP.OPDT , OP.ANESTYP , OP.OPCOMNAME , MEDBLOC.MEDNB , MEDBLOC.MEDNAME , MEDBLOC.MEDFIRSTNAME FROM OP , MEDBLOC WHERE (OP.OPDT LIKE '" + datedebut + "') AND (MEDBLOC.MEDNB = '" + valuemed1 + "' ) AND ( OP.SURGNB = '" + valuemed1 + "' ) AND MEDBLOC.MEDNB = OP.SURGNB  ORDER BY ABS(OPDT)";	
						    	}
						    	else {
						    	query = "SELECT OP.PATNAME , OP.PATFIRSTNAME, OP.PATSEX , OP.SURGNB , OP.LATEX , OP.PATNB , OP.ENTRYDT , OP.MEDSPE , OP.ANESNAME , OP.OPEXPBEGHR , OP.LITDEM , OP.ROOMID , OP.ENTRYHR , OP.OPDT , OP.ANESTYP , OP.OPCOMNAME , MEDBLOC.MEDNB , MEDBLOC.MEDNAME , MEDBLOC.MEDFIRSTNAME FROM OP , MEDBLOC WHERE (OP.OPDT LIKE '" + datedebut + "') AND (OP.MEDSPE LIKE '" + pickspenum +"' ) AND (MEDBLOC.MEDNB = '" + valuemed1 + "' ) AND ( OP.SURGNB = '" + valuemed1 + "' ) AND MEDBLOC.MEDNB = OP.SURGNB  ORDER BY ABS(OPDT)";	
						    	}
							}
							...
							if(pickspenum.equals("0")) {				    		
					    		...
					    		query = "SELECT OP.PATNAME , OP.PATFIRSTNAME, OP.PATSEX , OP.SURGNB , OP.LATEX , OP.PATNB , OP.ENTRYDT , OP.MEDSPE , OP.ANESNAME , OP.OPEXPBEGHR , OP.LITDEM , OP.ROOMID , OP.ENTRYHR , OP.OPDT , OP.ANESTYP , OP.OPCOMNAME , MEDBLOC.MEDNB , MEDBLOC.MEDNAME , MEDBLOC.MEDFIRSTNAME FROM OP , MEDBLOC WHERE (OP.OPDT LIKE '" + datedebut + "') AND (OP.MEDSPE LIKE '" + pickspenum +"' ) AND (MEDBLOC.MEDNB IN ('"
								+valuemed1+"','"+valuemed2+"')) AND (OP.SURGNB IN ('"+valuemed1+"','"+valuemed2+"')) AND MEDBLOC.MEDNB = OP.SURGNB   ORDER BY ABS(OPDT) , MEDBLOC.MEDNAME";				
					    	}
							}
